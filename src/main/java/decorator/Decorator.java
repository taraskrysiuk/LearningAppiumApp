...
//
//    public Decorator(SearchContext context, long implicitlyWaitTimeOut, TimeUnit timeUnit) {
...
//            return proxyForElement(ignored, locator, field.getType());
//        }
//
//        if(isListWrapElements(field)){
//            Class<?> wrapClass = wrapListClass(field);
//            return proxyForListElements(ignored, locator, wrapClass);
//        }
//
//        return null;
//    }
